...
<head>
    ...
    <style>
        ...
        .form-control:focus, .form-select:focus {
            ...
            box-shadow: 0 0 0 0.2rem rgba(92, 149, 233, 0.25);
        }
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-light rounded h-100 p-4">
                        <div class="row">
                            <div class="col-8">
                                <h6 class="mb-4"><i class="fas fa-file-alt me-2"></i>Generate Daily Time Record</h6>
                            </div>
                                    ...
                                    <div class="dtr-container" id="container">
                                        ...
                                        <table class="dtr-info-table">
                                            ...
                                            <tr>
                                                ...
                                                <td>Regular Days: <?php echo isset($regularDays) ? $regularDays : 'N/A'; ?></td>
                                                <td>Saturdays: <?php echo isset($saturdays) ? $saturdays : 'N/A'; ?></td>
                                                <td></td>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="dtr-table">
                                            ...
                                            for ($day = 1; $day <= 31; $day++) {
                                                ...
                                                echo "<tr><td colspan='8' class='text-center py-4 text-muted'><i class='fas fa-info-circle me-2'></i>Please search for personnel to generate DTR</td></tr>";
                                            endif;
                                            ?>
                                            </tbody>
                                            <tfoot>

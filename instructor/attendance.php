...
<body>
                                ...
                                <div class="text-center py-5">
                                    ...
                                    <?php if (empty($available_classes)): ?>
                                        <div class="alert alert-info mt-4">
                                            ...
                                            <br>Attendance data will appear here after you save sessions from scanner page.
                                        </div>
                                    <?php else: ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // If coming from dashboard with parameters, auto-submit form
            ...
            function updateFilters() {
                ...
                // For now, we'll rely on pre-populated options
            }
